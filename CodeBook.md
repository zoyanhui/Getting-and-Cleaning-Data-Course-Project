...
This is code book to describe the variables.
...
1. subject: experiment person
2. activity: activities performed by person
...
5. Creates a independent tidy data set with the average of each variable for each activity and each subject, and save to file.
